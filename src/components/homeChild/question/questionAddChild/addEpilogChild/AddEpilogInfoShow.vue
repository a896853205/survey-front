<!-- AddEpilogInfoShow
// addEpilogInfoShow 右边问卷数据展示
import AddEpilogForm from '@/components/homeChild/question/questionAddChild/addEpilogChild/AddEpilogInfoShow'
 -->
<template>
